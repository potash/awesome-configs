...
local function set_direction(data,direction)
  ...
  local top_clip_surface        = do_gen_menu_top(data,geometry.width,geometry.height,10,data.border_width,{bg=beautiful.menu_border_color or "#0000ff",fg=data.bg or "#00ffff"})
