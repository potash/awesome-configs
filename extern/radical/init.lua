...
local tooltip   = require( "extern.radical.tooltip"   )
...
return {
  layout     = require( "extern.radical.layout"     ),
  object     = require( "extern.radical.object"     ),
  base       = require( "extern.radical.base"       ),
  radial     = require( "extern.radical.radial"     ),
